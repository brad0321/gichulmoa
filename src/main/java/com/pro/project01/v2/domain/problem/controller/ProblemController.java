...
public class ProblemController {
    ...
    public String showCreateForm(Model model) {
        model.addAttribute("problem", new ProblemCreateRequest());
        model.addAttribute("subjects", subjectRepository.findAll());
        model.addAttribute("rounds", roundRepository.findAll());
        model.addAttribute("units", unitRepository.findAll());
        return "problems/problem-new"; // ✅ 템플릿명 반영
    }
    ...
    public String detail(@PathVariable Long id, Model model, HttpSession session) {
        ...
        model.addAttribute("loginUser", session.getAttribute("loginUser")); // 관리자 판단용
    ...
    public String editForm(@PathVariable Long id, Model model) {
        ...
        model.addAttribute("rounds", roundRepository.findAll());
        model.addAttribute("units", unitRepository.findAll());
        return "problems/edit"; // ✅ 기존 템플릿명 반영
    }
